...
def run(
    ...
    Args:
        ...
        data (Path | str): Path to the dataset.yaml file (default: ROOT / "data/VOC.yaml").
...
def test(
    ...
    Args:
        ...
        data (Path | str): Path to the dataset configuration file (.yaml format). Default is 'ROOT / "data/VOC.yaml"'.
...
def parse_opt():
    ...
    Args:
        ...
        data (str): Path to the dataset YAML file. Defaults to 'ROOT / "data/VOC.yaml"'.
